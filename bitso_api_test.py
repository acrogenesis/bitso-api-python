...
from bitso_account_creation_api import *

print bcolors.WARNING + "Using: " + bcolors.OKBLUE + bitso_api_credentials.baseUri + bcolors.ENDC
...
print bcolors.HEADER +  "## bitso account creation api ##\n\n"  + bcolors.ENDC
print bcolors.BOLD + "\nrequired fields: \n" + bcolors.ENDC + required_fields()
print bcolors.BOLD + "\ncreate account: \n" + bcolors.ENDC + create_account("test@test.test", "Test","Testez", "1971-01-01", "mx", "1234")
